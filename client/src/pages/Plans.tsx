...
> = {
  ...
  taste: {
    ...
    duration: "질문 10회",
    body:
      "**7대 사주명가의 비기를 탑재한 AI 상담\n마스터의 철학을 내재한 대체불가 AI 상담**\n\n질문은 10회로 넉넉히 제공합니다. 5만원짜리 상담, 그 이상의 퀄리티를 느껴보세요.",
  },
  deep: {
    no: "03",
    ...
    duration: "질문 15회",
    body:
      "**7대 사주명가의 비기를 탑재한 AI 상담\n마스터의 철학을 내재한 대체불가 AI 상담**\n\n질문은 15회로 좀 더 많은 문답을 주고받으실 수 있습니다. 10만원짜리 상담, 그 이상의 퀄리티를 느껴보세요.",
    accent: true,
    primary: true,
  },
  event: {
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-900/80 mt-0.5 leading-relaxed">
                결제 오류, 접속 지연, 사이트 오작동 등 문제가 있으면 카카오 채팅방으로 남겨주세요. <span className="font-semibold">채팅 응대 09:00~22:00</span>
              </p>
            </div>
          </div>
